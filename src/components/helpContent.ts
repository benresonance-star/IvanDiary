...
export const HELP_TIPS = {
  ...
  "shape-edit": { title: "Edit shape", body: "Use the adaptive shape inspector to move, rotate, resize, recolour, reshape, arrange, copy, or delete this shape. Large adjustment buttons provide an alternative to dragging." },
  ...
  "shape-colour": { title: "Shape appearance", body: "Open Appearance to change or remove the fill and outline, and adjust outline thickness." },
  ...
  "shape-duplicate": { title: "Duplicate shape", body: "Make an offset copy and select the new shape immediately." },
